...
public class OldGenBigTree extends WorldGenerator
{
    ...
    public OldGenBigTree(int type)
    {
        ...
        this.field_874_i = 0.38100000000000001D;
    ...
    void func_521_a()
    {
        ...
        int i = (int) (1.3819999999999999D + Math.pow((this.field_872_k * (double) this.field_878_e) / 13D, 2D));
        if (i < 1)
        {
            i = 1;
        }
        ...
        while (i1 >= 0)
        {
            ...
            else
            {
                ...
                for (; j1 < i; j1++)
                {
                    double d1 = this.field_873_j * ((double) f * ((double) this.field_881_b.nextFloat() + 0.32800000000000001D));
                    double d2 = (double) this.field_881_b.nextFloat() * 2D * 3.1415899999999999D;
                    ...
                    int ai3[] = {
                            this.basePos[0], this.basePos[1], this.basePos[2]
                    };
                    double d3 = Math.sqrt(Math.pow(Math.abs(this.basePos[0] - ai1[0]), 2D) + Math.pow(Math.abs(this.basePos[2] - ai1[2]), 2D));
        ...
        for (; j1 <= i1; j1++)
        {
            ...
            for (int l1 = -i1; l1 <= i1;)
            {
                ...
                else
                {
                    ...
                    Block i2 = OWGGenHelper.getBlock(this.worldObj, ai1[0], ai1[1], ai1[2]);
                    ...
                    {
                        OWGGenHelper.setBlockState(this.worldObj, ai1[0], ai1[1], ai1[2], l);
                        l1++;
                    }
                }
            }
    ...
    {
        if ((double) i < (double) (float) this.field_878_e * 0.29999999999999999D)
        {
            return -1.618F;
        }
        float f = (float) this.field_878_e / 2.0F;
        float f1 = (float) this.field_878_e / 2.0F - (float) i;
        float f2;
        if (f1 == 0.0F)
        {
            f2 = f;
    ...
    void func_522_a(int ai[], int ai1[], Block i)
    {
        ...
        for (int l = ai2[j] + byte3; k != l; k += byte3)
        {
            ...
            OWGGenHelper.setBlock(this.worldObj, ai3[0], ai3[1], ai3[2], i);
        }
    ...
    {
        return (double) i >= (double) this.field_878_e * 0.20000000000000001D;
    }
    ...
    void func_529_c()
    {
        ...
        this.func_522_a(ai, ai1, Blocks.log);
    ...
    void func_525_d()
    {
        ...
        for (; i < j; i++)
        {
            ...
            {
                this.func_522_a(ai, ai2, Blocks.log);
            }
        }
    ...
    int func_524_a(int ai[], int ai1[])
    {
        ...
        do
        {
            ...
            Block l = OWGGenHelper.getBlock(this.worldObj, ai3[0], ai3[1], ai3[2]);
    ...
    boolean func_519_e()
    {
        ...
        int ai1[] = {
                this.basePos[0], (this.basePos[1] + this.field_878_e) - 1, this.basePos[2]
        };
        Block i = OWGGenHelper.getBlock(this.worldObj, this.basePos[0], this.basePos[1] - 1, this.basePos[2]);
