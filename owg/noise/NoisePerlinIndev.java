...
public class NoisePerlinIndev extends OldNoiseGenerator2
{
    ...
    {
        double paramDouble4 = paramDouble1 + this.b;
        double paramDouble5 = paramDouble2 + this.c;
        double paramDouble6 = paramDouble3 + this.d;
        ...
        double l = this.a[(int) paramDouble1] + k;
        paramDouble3 = this.a[(int) l] + paramDouble2;
        l = this.a[(int) l + 1] + paramDouble2;
        paramDouble1 = this.a[(int) paramDouble1 + 1] + k;
        k = this.a[(int) paramDouble1] + paramDouble2;
        paramDouble1 = this.a[(int) paramDouble1 + 1] + paramDouble2;
        return c(paramDouble9,
                c(paramDouble8,
                        c(paramDouble7, a(this.a[(int) paramDouble3], paramDouble4, paramDouble5, paramDouble6),
                                a(this.a[(int) k], paramDouble4 - 1.0D, paramDouble5, paramDouble6)),
                        c(paramDouble7, a(this.a[(int) l], paramDouble4, paramDouble5 - 1.0D, paramDouble6),
                                a(this.a[(int) paramDouble1], paramDouble4 - 1.0D, paramDouble5 - 1.0D, paramDouble6))),
                c(paramDouble8,
                        c(paramDouble7, a(this.a[(int) paramDouble3 + 1], paramDouble4, paramDouble5, paramDouble6 - 1.0D),
                                a(this.a[(int) k + 1], paramDouble4 - 1.0D, paramDouble5, paramDouble6 - 1.0D)),
                        c(paramDouble7, a(this.a[(int) l + 1], paramDouble4, paramDouble5 - 1.0D, paramDouble6 - 1.0D),
                                a(this.a[(int) paramDouble1 + 1], paramDouble4 - 1.0D, paramDouble5 - 1.0D, paramDouble6 - 1.0D))));
    }
    ...
    {
        return this.b(paramDouble1, paramDouble2, 0.0D);
    }

    public final double a(double paramDouble1, double paramDouble2, double paramDouble3)
    {
        return this.b(paramDouble1, paramDouble2, paramDouble3);
    }
}