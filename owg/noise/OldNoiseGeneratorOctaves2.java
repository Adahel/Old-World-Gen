...
public class OldNoiseGeneratorOctaves2 extends NoiseGenerator
{
    ...
    {
        this.field_4233_b = i;
        this.field_4234_a = new OldNoiseGenerator2[i];
        for (int j = 0; j < i; j++)
        {
            this.field_4234_a[j] = new OldNoiseGenerator2(random);
        }
    ...
    {
        return this.func_4111_a(ad, d, d1, i, j, d2, d3, d4, 0.5D);
    }
            ...
            double d2, double d3, double d4, double d5)
    {
        ...
        {
            this.field_4234_a[l].func_4157_a(ad, d, d1, i, j, d2 * d7, d3 * d7, 0.55000000000000004D / d6);
            d7 *= d4;
            d6 *= d5;
        }
