        ...
        if (j == 1)
        {
            ...
            for (int i4 = 0; i4 < i; i4++)
            {
                ...
                for (int l4 = 0; l4 < k; l4++)
                {
                    ...
                    int l = this.permutations[k4] + 0; /// bwg4 made by ted80
                    int j1 = this.permutations[l] + l5;
                    int k1 = this.permutations[k4 + 1] + 0;
                    int l1 = this.permutations[k1] + l5;
                    double d9 = this.lerp(d17, this.func_4110_a(this.permutations[j1], d14, d19), this.grad(this.permutations[l1], d14 - 1.0D, 0.0D, d19));
                    double d11 = this.lerp(d17, this.grad(this.permutations[j1 + 1], d14, 0.0D, d19 - 1.0D),
                            this.grad(this.permutations[l1 + 1], d14 - 1.0D, 0.0D, d19 - 1.0D));
            ...
            for (int j6 = 0; j6 < k; j6++)
            {
                ...
                for (int i7 = 0; i7 < j; i7++)
                {
                    ...
                    if (i7 == 0 || k7 != i2)
                    {
                        ...
                        d13 = this.lerp(d22, this.grad(this.permutations[k2], d20, d26, d24), this.grad(this.permutations[k3], d20 - 1.0D, d26, d24));
                        d15 = this.lerp(d22, this.grad(this.permutations[l2], d20, d26 - 1.0D, d24),
                                this.grad(this.permutations[l3], d20 - 1.0D, d26 - 1.0D, d24));
                        d16 = this.lerp(d22, this.grad(this.permutations[k2 + 1], d20, d26, d24 - 1.0D),
                                this.grad(this.permutations[k3 + 1], d20 - 1.0D, d26, d24 - 1.0D));
                        d18 = this.lerp(d22, this.grad(this.permutations[l2 + 1], d20, d26 - 1.0D, d24 - 1.0D),
                                this.grad(this.permutations[l3 + 1], d20 - 1.0D, d26 - 1.0D, d24 - 1.0D));
                    }
