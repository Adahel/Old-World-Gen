...
public class BiomeList
{
    ...
    {
        OLDdesert = (new BiomeBeta(ConfigOWG.biomeIDs[0], 7)).setColor(16421912).setBiomeName("owg_desert").setTemperatureRainfall(0.95F, 0.1F)
                .setDisableRain();
        ...
        CLASSICsnow = (new BiomeClassic(ConfigOWG.biomeIDs[11])).setColor(353825).setBiomeName("owg_Classic_Snow").setEnableSnow().setTemperatureRainfall(0.0F,
                0.5F);
