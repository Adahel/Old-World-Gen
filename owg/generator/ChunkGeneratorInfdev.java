...
public class ChunkGeneratorInfdev implements IChunkProvider
{
    ...
    public ChunkGeneratorInfdev(World world, long l, boolean par4, boolean a, int bSettings)
    {
    ...
    public void populate(IChunkProvider ichunkprovider, int i, int j)
    {
        ...
        SpawnerAnimals.performWorldGenSpawning(this.field_907_p, this.chunkManager.getBiomeGenAtChunkCoord(chunkcoordintpair).handle, k + 8, l + 8, 16, 16,
                this.field_913_j);
        k += 8;
        l += 8;
    ...
    public void recreateStructures(Chunk chunk, int par1, int par2)
    {
        if (this.mapFeaturesEnabled)
        {
            this.strongholdGenerator.generate(this, this.field_907_p, par1, par2, (ChunkPrimer) null);
            this.mineshaftGenerator.generate(this, this.field_907_p, par1, par2, (ChunkPrimer) null);
        }
    }
}
