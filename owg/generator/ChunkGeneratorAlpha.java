...
public class ChunkGeneratorAlpha implements IChunkProvider
{
    ...
    public ChunkGeneratorAlpha(World world, long l, boolean par4)
    {
        ...
        this.chunkManager = new ManagerOWG(world, !world.isRemote, 0);
    ...
    public Chunk provideChunk(int i, int j)
    {
        ...
        {
            abyte1[k] = (byte) this.field_4179_v[k].handle.biomeID;
        }
    ...
    public void populate(IChunkProvider ichunkprovider, int i, int j)
    {
        ...
        if (biomegenbase == BiomeGenBase.OLDrainforest && this.field_913_j.nextInt(3) == 0)
        {
            obj = new OldGenBigTree(1);
        }
        ...
        SpawnerAnimals.performWorldGenSpawning(this.worldObj_16, this.chunkManager.getBiomeGenAtChunkCoord(chunkcoordintpair).handle, k + 8, l + 8, 16, 16,
                this.rand2);

        MinecraftForge.EVENT_BUS.post(new PopulateChunkEvent.Pre(ichunkprovider, this.worldObj_16, this.rand2, i, j, false));

        this.field_4178_w = this.chunkManager.getColdTemperatures(this.field_4178_w, k + 8, l + 8, 16, 16);
    ...
    public void recreateStructures(Chunk chunk, int par1, int par2)
    {
        if (this.mapFeaturesEnabled)
        {
            this.strongholdGenerator.generate(this, this.worldObj_16, par1, par2, (ChunkPrimer) null);
            this.mineshaftGenerator.generate(this, this.worldObj_16, par1, par2, (ChunkPrimer) null);
        }
    }
