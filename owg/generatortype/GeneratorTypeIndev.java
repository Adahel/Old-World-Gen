...
public class GeneratorTypeIndev extends GeneratorType
{
    ...
    public IChunkProvider getChunkGenerator(World world)
    {
        ...
        int biomes = trySetting(0, 4);
        return new ChunkGeneratorIndev(world, world.getSeed(), world.getWorldInfo().isMapFeaturesEnabled(), typeID, themeID, size, layers, dungeons, biomes);
    }
}
